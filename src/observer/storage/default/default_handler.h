...
public:
   ...
   * @return
   */
  RC create_index(Trx *trx, const char *dbname, const char *relation_name, const char *index_name, const char **attributes, 
      const size_t attribute_num, const size_t is_unique);
