...
RC PredicateOperator::do_predicate(RowTuple &tuple, bool &result)
{
  ...
  for (const FilterUnit *filter_unit : filter_stmt_->filter_units()) {
    BaseExpression *left_expr = filter_unit->left();
    BaseExpression *right_expr = filter_unit->right();
    ...
    int compare;
    rc = left_cell.compare(right_cell, compare, comp);
    if (rc != RC::SUCCESS) {
      result = false;
      return rc;
    }
...
//
//    int compare;
//    RC rc = left_cell.compare(right_cell,compare);
//    if (rc != RC::SUCCESS) {
//      result = false;
//      return rc;
//    }
