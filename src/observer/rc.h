...
enum RC {
  ...
  SHOULD_NOT_BE_CALLED, /* this function should not be called*/
  UNKNOWN_TYPE,     /* type is undefined */
  NO_SUCH_FUNC,     /*function doesn't exist*/
  PARA_DISMATCH,    /*function parameters doesn't */
  ERROR_INPUT_TYPE,
  ERROR_LOGIC_PLAN,

  EXPR_PARSE_ERROR, /* expression parse fail */
  CONST_PARSE_ERROR,/* constant parse error */
  ERROR_ALIAS,     /* should not have alias */
  ALIAS_REPEAT,
  ...
  SCHEMA_FIELD_NOT_NULL = (SCHEMA | (RCSchema::FIELD_NOT_NULL << 8)),
